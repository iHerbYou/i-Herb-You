...
VALUES
    ((SELECT id FROM code_group WHERE value = 10), 101, 'WAITING', '대기', 1, 1, NOW(), NOW()),
...
INSERT INTO code (code_group_id, value, display_name, description, is_active, sort_order, created_at, updated_at)
VALUES
    ((SELECT id FROM code_group WHERE value = 20), 201, 'PREPARING', '출고 준비', 1, 1, NOW(), NOW()),
...
INSERT INTO code (code_group_id, value, display_name, description, is_active, sort_order, created_at, updated_at)
VALUES
    ((SELECT id FROM code_group WHERE value = 30), 301, 'PENDING', '주문 생성', 1, 1, NOW(), NOW()),
...
INSERT INTO code (code_group_id, value, display_name, description, is_active, sort_order, created_at, updated_at)
VALUES
    ((SELECT id FROM code_group WHERE value = 40), 401, 'READY', '결제 대기', 1, 1, NOW(), NOW()),
...
INSERT INTO code (code_group_id, value, display_name, description, is_active, sort_order, created_at, updated_at)
VALUES
    ((SELECT id FROM code_group WHERE value = 41), 411, 'CARD', '신용/체크카드', 1, 1, NOW(), NOW()),
...
INSERT INTO code (code_group_id, value, display_name, description, is_active, sort_order, created_at, updated_at)
VALUES
    ((SELECT id FROM code_group WHERE value = 50), 501, 'ACTIVE', '활성', 1, 1, NOW(), NOW()),
...
INSERT INTO code (code_group_id, value, display_name, description, is_active, sort_order, created_at, updated_at)
VALUES
    ((SELECT id FROM code_group WHERE value = 51), 511, 'AMOUNT', '정액', 1, 1, NOW(), NOW()),
    ((SELECT id FROM code_group WHERE value = 51), 512, 'PERCENT', '정률', 1, 2, NOW(), NOW());

-- 52: APPLICABLE_SCOPE (521~)
INSERT INTO code (code_group_id, value, display_name, description, is_active, sort_order, created_at, updated_at)
VALUES
    ((SELECT id FROM code_group WHERE value = 52), 521, 'ALL', '전체', 1, 1, NOW(), NOW()),
...
INSERT INTO code (code_group_id, value, display_name, description, is_active, sort_order, created_at, updated_at)
VALUES
    ((SELECT id FROM code_group WHERE value = 53), 531, 'ALL', '전체', 1, 1, NOW(), NOW()),
...
INSERT INTO code (code_group_id, value, display_name, description, is_active, sort_order, created_at, updated_at)
VALUES
    ((SELECT id FROM code_group WHERE value = 60), 601, 'REQUESTED', '요청', 1, 1, NOW(), NOW()),
...
INSERT INTO code (code_group_id, value, display_name, description, is_active, sort_order, created_at, updated_at)
VALUES
    ((SELECT id FROM code_group WHERE value = 61), 611, 'CHANGE_OF_MIND', '단순 변심', 1, 1, NOW(), NOW()),
...
INSERT INTO code (code_group_id, value, display_name, description, is_active, sort_order, created_at, updated_at)
VALUES
    ((SELECT id FROM code_group WHERE value = 62), 621, 'SELF_SHIP', '고객 직접 반송', 1, 1, NOW(), NOW()),
    ((SELECT id FROM code_group WHERE value = 62), 622, 'CARRIER_PICKUP', '택배사 수거', 1, 2, NOW(), NOW());

-- 70: USER_ROLE (701~)
INSERT INTO code (code_group_id, value, display_name, description, is_active, sort_order, created_at, updated_at)
VALUES
    ((SELECT id FROM code_group WHERE value = 70), 701, 'USER', '일반회원', 1, 1, NOW(), NOW()),
...
INSERT INTO code (code_group_id, value, display_name, description, is_active, sort_order, created_at, updated_at)
VALUES
    ((SELECT id FROM code_group WHERE value = 71), 711, 'DELETED', '탈퇴', 1, 1, NOW(), NOW()),
...
INSERT INTO code (code_group_id, value, display_name, description, is_active, sort_order, created_at, updated_at)
VALUES
    ((SELECT id FROM code_group WHERE value = 80), 801, 'LOCAL', '로컬', 1, 1, NOW(), NOW()),
...
INSERT INTO code (code_group_id, value, display_name, description, is_active, sort_order, created_at, updated_at)
VALUES
    ((SELECT id FROM code_group WHERE value = 90), 901, 'SERVICE', '서비스 이용약관', 1, 1, NOW(), NOW()),
...
INSERT INTO code (code_group_id, value, display_name, description, is_active, sort_order, created_at, updated_at)
VALUES
    ((SELECT id FROM code_group WHERE value = 100), 1001, 'SPAM', '스팸/광고', 1, 1, NOW(), NOW()),
...
INSERT INTO code (code_group_id, value, display_name, description, is_active, sort_order, created_at, updated_at)
VALUES
    ((SELECT id FROM code_group WHERE value = 101), 1011, 'PENDING', '접수', 1, 1, NOW(), NOW()),
